...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_binop','parser.py',6),
  ('expression -> expression MINUS term','expression',3,'p_expression_binop','parser.py',7),
  ('expression -> term','expression',1,'p_expression_term','parser.py',11),
  ('term -> term TIMES factor','term',3,'p_term_binop','parser.py',15),
  ('term -> term DIVIDE factor','term',3,'p_term_binop','parser.py',16),
  ('term -> factor','term',1,'p_term_factor','parser.py',20),
  ('factor -> NUMBER','factor',1,'p_factor_num','parser.py',24),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','parser.py',28),
]
